    ...
    for group_id in range(4):
        ...
        for _, build_row in items_build.iterrows():
            ...
            for _, combo_row in combos.iterrows():
                ...
                if (build_row['s1'] == combo_row['s1'] and build_row['s2'] ==
                ...
                elif (build_row['s1'] == combo_row['s1'] and build_row['s2'] ==
                ...
                elif (build_row['s1'] == combo_row['s2'] and build_row['s2'] ==
                ...
                elif (build_row['s1'] == combo_row['s3'] and build_row['s2'] ==
                    ...
                    found_combo = True
                        ...
                        combo_row['s2'] and build_row['s3'] == combo_row['s1']):
